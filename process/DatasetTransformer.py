class DatasetTransformer:
    ...
    def transform_test_dataset(self, test_dataset_name):
        test_dataset = self.dataset[test_dataset_name].map(
            self.preprocess_validation,
            batched=True,
            remove_columns=self.dataset[test_dataset_name].column_names,
        )
        return test_dataset